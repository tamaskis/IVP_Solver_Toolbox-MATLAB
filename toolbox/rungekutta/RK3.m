%==========================================================================
%
% RK3  (Kutta's) Runge-Kutta third-order method.
%
%   [t,y] = RK3(f,[t0,tf],y0,h)
%   [t,y] = RK3(f,{t0,C},y0,h)
%   [t,y] = RK3(__,wb)
%
% See also euler, RK2, RK2_heun, RK2_ralston, RK3_heun, RK3_ralston,
...
function [t,y] = RK3(f,I,y0,h,wb)
    ...
    if time_detection_implementation
        ...
        % propagating state vector using Kutta's third-order method
        for n = 1:N
