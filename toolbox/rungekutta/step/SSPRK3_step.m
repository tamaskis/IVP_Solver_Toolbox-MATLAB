%==========================================================================
%
% SSPRK3_step  Propagates the state vector forward one time step using 
...
% RK3_heun_step, RK3_ralston_step, RK4_step, RK4_ralston_step, RK4_38_step.
%
...
%
%==========================================================================
function y_next = SSPRK3_step(f,t,y,h)
