...
%
%==========================================================================
function [t,y] = RK4_ralston(f,I,y0,h,wb)
    ...
    if time_detection_implementation
        ...
        % propagating state vector using Ralston's fourth-order method
        for n = 1:N
            ...
            % k terms
            k1 = f(tn,yn);
            k2 = f(tn+0.4*h,yn+0.4*h*k1);
            k3 = f(tn+0.45573725*h,yn+0.29697761*h*k1+0.15875964*h*k2);
            k4 = f(tn+h,yn+0.21810040*h*k1-3.05096516*h*k2+3.83286476*h*...
                k3);

            % state vector propagated to next sample time
            y(:,n+1) = yn+h*(0.17476028*k1-0.55148066*k2+1.20553560*k3+...
                0.17118478*k4);
