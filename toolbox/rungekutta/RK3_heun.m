%==========================================================================
%
% RK3_heun  Heun's third-order method (Runge-Kutta third-order method).
%
%   [t,y] = RK3_heun(f,[t0,tf],y0,h)
%   [t,y] = RK3_heun(f,{t0,C},y0,h)
%   [t,y] = RK3_heun(__,wb)
%
% See also RK1_euler, RK2, RK2_heun, RK2_ralston, RK3, RK3_ralston, SSPRK3, 
...
%
%==========================================================================
function [t,y] = RK3_heun(f,I,y0,h,wb)
    ...
    if time_detection_implementation
        ...
        % propagating state vector using Heun's third-order method
        for n = 1:N
