%==========================================================================
%
% RK2_ralston  Ralston's second-order method (Runge-Kutta second-order 
% method).
%
...
%
% See also RK1_euler, RK2, RK2_heun, RK3, RK3_heun, RK3_ralston, SSPRK3,
...
%
%==========================================================================
function [t,y] = RK2_ralston(f,I,y0,h,wb)
    ...
    if time_detection_implementation
        ...
        % propagating state vector using Ralston's second-order method
        for n = 1:N
            ...
            % k terms
            k1 = f(tn,yn);
            k2 = f(tn+2*h/3,yn+2*h*k1/3);

            % state vector propogated to next sample time
            y(:,n+1) = yn+(h/4)*(k1+3*k2);
