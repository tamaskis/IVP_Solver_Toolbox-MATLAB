%==========================================================================
%
% RK2_heun  Heun's second-order method (Runge-Kutta second-order method).
%
...
%
%==========================================================================
function [t,y] = RK2_heun(f,I,y0,h,wb)
    ...
    if time_detection_implementation
        ...
        % propagating state vector using Heun's second-order method
        for n = 1:N
