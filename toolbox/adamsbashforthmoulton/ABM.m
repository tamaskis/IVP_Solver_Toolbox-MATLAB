%==========================================================================
%
% ABM  Adams-Bashforth-Moulton methods.
%
%   [t,y] = ABM(f,[t0,tf],y0,h)
%   [t,y] = ABM(f,{t0,C},y0,h)
%   [t,y] = ABM(__,wb)
%
% See also ABM2, ABM3, ABM4, ABM5, ABM6, ABM7, ABM8.
%
...
%   m       - (1×1 double) order of the multistep method
...
%
%==========================================================================
function [t,y] = ABM(f,I,y0,h,wb,m)
    ...
    if time_detection_implementation
        ...
        % propagating state vector using ABM2
        for n = (m+1):N
