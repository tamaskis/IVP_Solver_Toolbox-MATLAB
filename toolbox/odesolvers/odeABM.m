%==========================================================================
%
% odeABM  Fixed-step ODE solver using the Adams-Bashforth-Moulton methods.
%
%   [t,y] = odeABM(f,[t0,tf],y0,h)
%   [t,y] = odeABM(f,{t0,C},y0,h)
%   [t,y] = odeABM(__,method)
%   [t,y] = odeABM(__,method,wb)
%
% See also odeRK, odeAB.
%
...
%   method  - (char) (OPTIONAL) Adams-Bashforth-Moulton method --> 'ABM2', 
%             'ABM3', 'ABM4', 'ABM5', 'ABM6', 'ABM7', 'ABM8' (defaults to 
%             'ABM8')
...
%
%==========================================================================
function [t,y] = odeABM(f,I,y0,h,method,wb)
    ...
    % defaults integration method to ABM8
    ...
    if strcmpi(method,'ABM8')
        propagate = @(t,F) ABM8(f,t,F,h);
        m = 8;
    elseif strcmpi(method,'ABM2')
