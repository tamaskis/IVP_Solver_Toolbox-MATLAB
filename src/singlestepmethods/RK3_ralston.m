...
%
% See also euler, RK2, RK2_heun, RK2_ralston, RK3, RK3_heun, SSPRK3, RK4, 
% RK4_ralston, RK4_38.
%
...
%
%==========================================================================
function [t,y] = RK3_ralston(f,interval,y0,h)
    ...
    if strcmp(implementation,'time')
        ...
        for i = 1:N
            ...
            k3 = f(ti+3*h/4,yi+3*h*k2/4);

            % state vector propogated to next iteration
            y(:,i+1) = yi+(h/9)*(2*k1+3*k2+4*k3);
