...
%
%   [num,gcd] = AM_coefficients(n,print)
...
%             nth-order Adams-Moulton predictor
%   gcd     - (1×1 double) greatest common denimonator of b
%
%==========================================================================
function [num,gcd] = AM_coefficients(n,print)
    ...
    if strcmp(print,'print')
        fprintf("%dth-order Adams-Moulton corrector coefficients:",n);
        for i = 1:length(num)
            fprintf("\nb(%d) = %d/%d",i,num(i),gcd);
        end
        fprintf("\n\n\n");
