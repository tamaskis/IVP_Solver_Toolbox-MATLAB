...
%
% _Find the solution $y(t)$ until $t=10$ using |euler_step|. Then, compare
% your result to the solution found by |euler|._
%
...
t = (2:h:10)';
%%
% Solving for $y(t)$ using |euler_step| and comparing the result to the
% result obtained using |euler|,
