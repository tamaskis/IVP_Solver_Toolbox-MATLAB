%% |RK4_step|
% Propagates the state vector forward one time step using the (classic) 
...
%% Description
% |y_next = RK4_step(f,t,y,h)| returns the state vector at the next 
...
%
% _Find the solution $y(t)$ until $t=10$ using |RK4_step|. Then, compare
% your result to the solution found by |RK4_step|._
%
...
t = (2:h:10)';
%%
% Solving for $y(t)$ using |RK4_step| and comparing the result to the
