...
%% Syntax
%   [t,y] = RK3_heun(f,[t0,tf],y0,h)
%   [t,y] = RK3_heun(f,{t0,C},y0,h)
%   [t,y] = RK3_heun(__,wb)
%% Description
% |[t,y] = RK3_heun(f,[t0,tf],y0,h)| solves the ODE defined by |f(t,y)|
% |from t0| until |tf| using Heun's third-order method with an initial 
...
[t,y] = RK3_heun(f,[20,10],y20,0.001);
%%
...
[t,y] = RK3_heun(f,[10,20],y10,0.001);
y20 = y(end)
