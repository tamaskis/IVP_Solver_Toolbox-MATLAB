%% |RK4_38_step|
% Propagates the state vector forward one time step using the 3/8-Rule 
...
%% Description
% |y_next = RK4_38_step(f,t,y,h)| returns the state vector at the next 
...
%
% _Find the solution $y(t)$ until $t=10$ using |RK4_38_step|. Then, compare
% your result to the solution found by |RK4_38_step|._
%
...
t = (2:h:10)';
%%
% Solving for $y(t)$ using |RK4_38_step| and comparing the result to the
% result obtained using |RK4|,
...
% solving using "RK4_38_step"
for i = 1:(length(t)-1)
    y(i+1) = RK4_38_step(f,t(i),y(i),h);
end

% solving using "RK4_38"
[t_RK4,y_RK4] = RK4_38(f,[2,10],y2,h);
